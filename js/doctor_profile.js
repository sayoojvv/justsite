...
$(document).ready(function () {
    $(".writereview").on("click", function () {
        var eleid = $(this).attr('data-hospid');
    ...
    $(document).on("click", '#btnsubmithosp', function () {
        $('form[data-parsley-validate]').parsley().validate();
        validateFront();
    });
});
var validateFront = function () {
    console.log('parseley valid = ' + $('form[data-parsley-validate]').parsley().isValid());
    if (false === $('form[data-parsley-validate]').parsley().isValid()) {
