...
<html lang="en">
   <head>
      ...
      <script src="<?php echo HOS_WEBROOT_URL; ?>js/jssor.slider-25.2.0.min.js" type="text/javascript"></script>
      ...
      <script src="<?php echo HOS_WEBROOT_URL; ?>js/rating.js" type="text/javascript"></script>
